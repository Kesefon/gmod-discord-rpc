...
if not file.Exists('lua/bin/gmcl_fluffydiscord_win32.dll', 'GAME') and not file.Exists('lua/bin/gmcl_fluffydiscord_win64.dll', 'GAME') and not file.Exists('lua/bin/gmcl_fluffydiscord_linux.dll', 'GAME') then return end
